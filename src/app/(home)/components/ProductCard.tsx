        ...
        <CardFooter className="flex items-center justify-between mt-2">
          ...
          <Dialog>
            ...
            <DialogContent className="max-w-3xl p-0">
              <div className="flex ">
                <div className="w-1/3 bg-white rounded p-8 flex items-center justify-center"><Image src={product.image} alt={product.name} width={400} height={400 } /></div>
                <div className="w-2/3 p-8">
                  ...
                  <div>
                                ...
                                <div className="flex items-center justify-between mt-6">
                                    <span className="font-bold">₹{product.price}</span>
                                    <Button className=""><ShoppingCart/><span>Add to cart</span></Button>
                                </div>
                </div>
              </div>
            </DialogContent>

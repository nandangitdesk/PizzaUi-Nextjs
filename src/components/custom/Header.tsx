...
const Header = () => {
  return (
    <header className="bg-white">
      <nav className="container py-5 px-36 flex items-center justify-between">
        ...
        <Select>
          ...
          <SelectContent>
            <SelectItem value="chessy-delight">Cheesy Delight</SelectItem>
        ...
        <div className="flex items-center gap-x-4">
           <ul className="flex space-x-4 font-medium">
              <li><Link className="hover:text-primary transition-all duration-200" href={"/"}>Menu </Link></li>
              <li><Link className="hover:text-primary transition-all duration-200" href={"/"}>Orders </Link></li>
           </ul>
           <div className="relative">
             <Link href={"/cart"}>
              <ShoppingBasket className="hover:text-primary transition-all duration-200"/>
             </Link>
             <span className="absolute -top-4 -right-5 h-6 w-6 rounded-full bg-primary flex items-center justify-center font-bold  text-white">
                3
             </span>
           </div>
